...
// Allocates and returns a compact profiler summary (header + top N lines + footer). Caller owns the
// returned buffer and must free() it. Returns nullptr if there's nothing to report.
