...
// CLUT in PSMCT32 layout (PS2-native): word memory is 0xAABBGGRR, alpha 0..0x80 (0x80 = fully
// opaque on the GS). Index 0 = fully transparent; index 15 = opaque white. White RGB lets the
// renderer tint via per-vertex color.
