...
void WGPURender_beginFrame(Renderer* renderer, int32_t gameW, int32_t gameH, int32_t windowW, int32_t windowH) {
    WGPURender* self = (WGPURender*)renderer;
...
void WGPURender_beginGUI(Renderer* renderer, int32_t guiW, int32_t guiH, int32_t portX, int32_t portY, int32_t portW, int32_t portH, int32_t targetSurfaceId) {
    WGPURender* self = (WGPURender*)renderer;
}
...
void WGPURender_drawSprite(Renderer* renderer, int32_t tpagIndex, float x, float y,
...
void WGPURender_drawSpritePart(Renderer* renderer, int32_t tpagIndex,
    ...
    (void)self;
    (void)tpagIndex;
    (void)srcOffX; (void)srcOffY; (void)srcW; (void)srcH;
    (void)x; (void)y;
    (void)xscale; (void)yscale;
    (void)angleDeg;
...
void WGPURender_drawSpritePartColor(Renderer* renderer, int32_t tpagIndex,
                                    int32_t srcOffX, int32_t srcOffY, int32_t srcW, int32_t srcH,
                                    float x, float y, float xscale, float yscale,
                                    float angleDeg, float pivotX, float pivotY,
...
void WGPURender_drawSpritePos(Renderer* renderer, int32_t tpagIndex,
...
void WGPURender_drawRectangle(Renderer* renderer, float x1, float y1,
...
void WGPURender_drawRectangleColor(Renderer* renderer, float x1, float y1,
                                   float x2, float y2,
                                   uint32_t color1, uint32_t color2,
...
void WGPURender_drawLine(Renderer* renderer, float x1, float y1,
...
void WGPURender_drawTriangle(Renderer* renderer,
                             float x1, float y1, float x2, float y2,
                             float x3, float y3,
...
void WGPURender_drawLineColor(Renderer* renderer, float x1, float y1,
                              float x2, float y2, float width,
                              uint32_t color1, uint32_t color2,
                              float alpha) {
    WGPURender* self = (WGPURender*)renderer;
...
void WGPURender_drawText(Renderer* renderer, const char* text,
                         float x, float y, float xscale, float yscale,
...
void WGPURender_drawTextColor(Renderer* renderer, const char* text,
                              float x, float y, float xscale, float yscale,
                              float angleDeg,
...
int32_t WGPURender_createSpriteFromSurface(Renderer* renderer, int32_t surfaceID,
...
void WGPURender_gpuSetBlendModeExt(Renderer* renderer,
...
void WGPURender_gpuSetColorWriteEnable(Renderer* renderer,
...
void WGPURender_gpuGetColorWriteEnable(Renderer* renderer,
                                       bool* red, bool* green, bool* blue, bool* alpha) {
    WGPURender* self = (WGPURender*)renderer;
    (void)self;
    (void)red;
...
void WGPURender_drawTile(Renderer* renderer, RoomTile* tile,
...
void WGPURender_drawSpriteTiled(Renderer* renderer, int32_t tpagIndex,
...
int32_t WGPURender_ensureApplicationSurface(Renderer* renderer,
...
void WGPURender_drawSurface(Renderer* renderer, int32_t surfaceID,
...
void WGPURender_drawSurfaceColor(Renderer* renderer, int32_t surfaceID,
                                 int32_t srcLeft, int32_t srcTop,
                                 int32_t srcWidth, int32_t srcHeight,
                                 float x, float y, float xscale, float yscale,
                                 float angleDeg,
...
void WGPURender_drawSurfaceTiled(Renderer* renderer, int32_t surfaceID,
                                 float x, float y, float xscale, float yscale,
                                 float roomW, float roomH,
                                 uint32_t color, float alpha) {
    WGPURender* self = (WGPURender*)renderer;
...
void WGPURender_surfaceResize(Renderer* renderer, int32_t surfaceID,
                              int32_t width, int32_t height) {
    WGPURender* self = (WGPURender*)renderer;
    (void)self;
    (void)surfaceID;
...
void WGPURender_surfaceCopy(Renderer* renderer,
...
bool WGPURender_surfaceGetPixels(Renderer* renderer, int32_t surfaceID,
                                  uint8_t* outRGBA) {
    WGPURender* self = (WGPURender*)renderer;
    (void)self;
    (void)surfaceID;
...
void WGPURender_drawTiledPart(Renderer* renderer, int32_t tpagIndex,
...
int32_t WGPURender_shaderGetUniform(Renderer* renderer, int32_t shaderIndex,
                                    char* uniform) {
    WGPURender* self = (WGPURender*)renderer;
    (void)self;
    (void)shaderIndex;
...
int32_t WGPURender_shaderGetSamplerIndex(Renderer* renderer, int32_t shaderIndex,
                                         char* uniform) {
    WGPURender* self = (WGPURender*)renderer;
    (void)self;
    (void)shaderIndex;
...
void WGPURender_shaderSetUniformF(Renderer* renderer, int32_t handle, int32_t count,
...
void WGPURender_shaderSetUniformFArray(Renderer* renderer, int32_t handle,
...
void WGPURender_shaderSetUniformI(Renderer* renderer, int32_t handle, int32_t count,
...
bool WGPURender_textureGetUVs(Renderer* renderer, uint32_t texID,
                              float* outUVs) {
    WGPURender* self = (WGPURender*)renderer;
    (void)self;
    (void)texID;
...
bool WGPURender_shadersSupported(void) {
    return false;
}
...
int32_t WGPURender_videoUploadFrame(Renderer* renderer,
                                    int32_t width, int32_t height,
                                    const uint8_t* rgba) {
    WGPURender* self = (WGPURender*)renderer;
    (void)self;
