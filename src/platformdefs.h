...
enum GraphicsAPI { SOFTWARE, MODERN_GL, LEGACY_GL, WGPU };
...
typedef struct {
	...
	int32_t windowWidth,
		windowHeight;  // 0 = auto (gen8 default, or the console-native size for console os-types)
