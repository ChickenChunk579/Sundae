...
typedef struct {
	...
	// Total length of a sound in seconds. Accepts either a SOND index or an active sound instance
	// id. Returns 0.0 if unknown (e.g. stream not yet loaded or invalid index).
