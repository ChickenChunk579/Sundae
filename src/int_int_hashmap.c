...
// Reinserts an existing (key, value) into a freshly-grown table. Skips the resize check and the
// count update because the caller has already accounted for both.
